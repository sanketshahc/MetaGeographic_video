...
// the server needs to tell the client what room to go to. 

// socket in to server

console.log('got ipaddy:', ipaddy)
var socket = io.connect(ipaddy);
// room is nothign right now. 
// on connect, they wait for a msg name 'assign', which hs metadata

socket.on('assign', function(roomassign){
  room = roomassign;
  maybeStart();
  // ??
})
...
// not sure, some kind of logging event.
